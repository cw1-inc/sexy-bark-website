        ...
        <>
            ...
            <div className="container py-5 privacy-policy">
                ...
                <div>
                    ...
                    <p>Thank you for visiting the Privacy Policy of SexyBark - a product provided by CW1 Inc. This Privacy Policy explains how CW1 (collectively, “CW1”, “we”, “us”, or “our”) collects, uses, and shares information about you (“you”, “yours” or “user”) when you access or use our websites (“Services”).</p>
                    ...
                    <p><strong>Account Information: </strong>if you create an account on the Services, we collect the information you provide to us related to the account, such as first and last name, username, and mobile phone, and activation tokens. </p>
                    <p><strong>Transactional Information: </strong>such as items placed in your cart, products purchased, product details,  purchase price, purchased date and payment information.</p>
                    <br />
                    ...
                    <ul>
                        <li>
                            <p><strong>With Microsoft Azure. </strong>We may share data with Microsoft Azure since our datacenter is hosted in the cloud and Apple Inc or Google Inc when handling payment information.</p>
                        </li>
                        <li>
                    ...
                    <p>We may use third-party advertising companies to serve content and advertisements when you visit our App.</p>
                    <br />
                    <h3>Data Security</h3>
                    ...
                    <p>If you are a California resident and the processing of personal information about you is subject to the California Consumer Privacy Act (“CCPA”), you have certain rights with respect to that personal information. Under the CCPA, subject to certain exceptions, “personal information” is any information that identifies, relates to, describes, is reasonably capable of being associated with, or could reasonably be linked, directly or indirectly, with a particular California resident or household.</p>
                    <p>If you are a CA resident, you have a right to request that we provide you with the following information:</p>
                    <ul>
                        <li>
                            <p>The categories and specific pieces of personal information we have collected about you. We have disclosed the categories of information under “Information We Collect”, above.</p>
                        </li>
                        <li>
                            <p>The categories of sources from which we collect personal information. We have disclosed the categories of sources under “Source of Information and Tracking Technologies”, above.</p>
                        </li>
                        <li>
                            <p>The purposes for collecting, using, or selling personal information. We have disclosed these purposes under “How We Use Your Information” and “How We May Share Information” above.</p>
                        </li>
                        <li>
                            <p>The categories of third parties with which we share personal information. We have disclosed the categories of third parties under “How We May Share Information” above.</p>
                        </li>
                        <li>
                            <p>The categories of personal information disclosed about you for a business purpose. We have disclosed the categories of third parties under “How We May Share Information” above.</p>
                        </li></ul>

                    <p>You also have a right to request that we delete your CCPA personal information under certain circumstances, subject to certain exceptions.</p>
                    <p>Finally, you have a right not to be discriminated against for exercising rights set out in the CCPA.</p>
                    <p>Please note we have the right to take reasonable steps to verify your identity and the authenticity of your request.</p>
                    <br />
                    ...
                    <p>To access your privacy rights, send us an email at info@cw1.com.</p>
                    ...
                    <p>The data controller responsible in accordance with the purposes of the General Data Protection Regulation (GDPR) and other data protection regulations is:</p>
                    <p>CW1 AB <br />Torggatan 8 <br /> 411 05 Gothenburg <br />Sweden</p>
